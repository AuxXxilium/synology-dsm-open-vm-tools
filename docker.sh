...
cd /spksrc/spk/open-vm-tools/ && make arch-epyc7002-7.1
...
cd /spksrc/spk/open-vm-tools/ && make arch-broadwellnkv2-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-broadwellntbap-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-denverton-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-geminilake-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-purley-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-r1000-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-v1000-7.2
cd /spksrc/spk/open-vm-tools/ && make arch-epyc7002-7.2
exit 0